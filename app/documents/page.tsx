...
async function DocumentsList() {
  ...
  return (
    <div className="container mx-auto max-w-7xl px-6 py-16">
      {/* Header Section */}
      <div className="mb-12">
        <h1 className="mb-4 font-sans text-[38px] font-bold tracking-tight text-gray-900">
          ...
          fallback={
            <div className="container mx-auto max-w-7xl px-4 py-12">
              <div className="animate-pulse">
                <div className="mb-12">
                  <div className="mb-4 h-10 w-96 rounded bg-charcoal-200" />
                  <div className="h-6 w-full max-w-2xl rounded bg-charcoal-100" />
                </div>
                <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                  {[...Array(6)].map((_, i) => (
                    ...
                    >
                      <div className="mb-3 h-6 w-24 rounded bg-charcoal-200" />
                      <div className="mb-2 h-6 w-full rounded bg-charcoal-200" />
                      <div className="h-20 w-full rounded bg-charcoal-100" />
                    </div>
                  ))}
                </div>
              </div>
